...
median_person_age <- function(geo_names, start_year=2011, end_year=2018, year=NA) {
...
median_male_person_age <- function(geo_names, start_year=2011, end_year=2018, year=NA) {
...
median_female_person_age <- function(geo_names, start_year=2011, end_year=2018, year=NA) {
