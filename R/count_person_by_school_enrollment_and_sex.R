...
#' and the observation year period. The count is sub-divided by the school
...
#'    by the observation year, the school enrollment group and the sex category.
#'     
#' @export
#' @examples
...
#' count_person_by_school_enrollment_and_sex(zips)
#' 
#' # Count the population from 2012 to 2015
#' count_person_by_school_enrollment_and_sex(zips, start_year=2012, end_year=2015)
#' 
#' # Count the population in 2012
#' count_person_by_school_enrollment_and_sex(zips, year=2012)
#' 
#' # Count the population in the state of California
#' count_person_by_school_enrollment_and_sex(c("California")) # State name
#' count_person_by_school_enrollment_and_sex(c("CA")) # State code
#' count_person_by_school_enrollment_and_sex(c("06")) # 2-digit state FIPS code
count_person_by_school_enrollment_and_sex <- function(geo_names,
