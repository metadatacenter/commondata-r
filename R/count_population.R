#' Return the total population by age brackets, given the ZIP codes and
...
#'    NA by default.
#' @return A named list with each list item is a data frame of the total
...
#' 
#' # Count the total population in specific ZIP codes
...
#' zips <- c("94035","94039","94040","94041","94042","94043")
#' 
#' # Count the male population in specific ZIP codes
